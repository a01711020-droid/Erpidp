...
async def ensure_tables(conn) -> None:
    ...
    await conn.execute(
        ...
        CREATE TABLE IF NOT EXISTS obras (
          ...
          anticipo_porcentaje NUMERIC(5, 2) DEFAULT 0 CHECK (anticipo_porcentaje >= 0),
          retencion_porcentaje NUMERIC(5, 2) DEFAULT 0 CHECK (retencion_porcentaje >= 0),
          saldo_actual NUMERIC(15, 2) DEFAULT 0 CHECK (saldo_actual >= 0),
          total_estimaciones NUMERIC(15, 2) DEFAULT 0 CHECK (total_estimaciones >= 0),
          total_gastos NUMERIC(15, 2) DEFAULT 0 CHECK (total_gastos >= 0),
          avance_fisico_porcentaje NUMERIC(5, 2) DEFAULT 0 CHECK (avance_fisico_porcentaje >= 0),
    ...
    await _ensure_columns(
        ...
        [
            ("direccion", "TEXT"),
            ("residente_iniciales", "VARCHAR(10)"),
            ("anticipo_porcentaje", "NUMERIC(5, 2) DEFAULT 0"),
            ("retencion_porcentaje", "NUMERIC(5, 2) DEFAULT 0"),
            ("saldo_actual", "NUMERIC(15, 2) DEFAULT 0"),
            ("total_estimaciones", "NUMERIC(15, 2) DEFAULT 0"),
            ("total_gastos", "NUMERIC(15, 2) DEFAULT 0"),
            ("avance_fisico_porcentaje", "NUMERIC(5, 2) DEFAULT 0"),
            ("updated_at", "TIMESTAMPTZ DEFAULT NOW()"),
        ],
    )
