                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {works.filter((w) => w.status === "Activa").length}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        ${
                          works
                            .reduce((sum, work) => sum + work.contractAmount, 0)
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        ${
                          works
                            .reduce((sum, work) => sum + (work.totalEstimates || 0), 0)
                            .toLocaleString("es-MX")
                        }
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        ${
                          works
                            .reduce((sum, work) => sum + (work.totalExpenses || 0), 0)
                            .toLocaleString("es-MX")
                        }
                      </p>
                    </div>
