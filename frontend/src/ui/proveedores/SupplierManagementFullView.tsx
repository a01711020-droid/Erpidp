...
export interface SupplierManagementFullProps {
  onBack?: () => void;
  suppliersData?: Supplier[];
}

export default function SupplierManagementFull({ onBack, suppliersData = [] }: SupplierManagementFullProps) {
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="razonSocial"
                    placeholder="Ej: Razón Social del Proveedor"
