...
export default function DestajistasManagement({ onBack }: Props) {
  const [destajistas] = useState<Destajista[]>([]);
  const isModuleAvailable = false;
        ...
        <Card className="p-6">
          ...
          {destajistas.length === 0 && (
            <div className="text-center py-12">
              ...
              <Button onClick={handleOpenForm} className="mt-4" disabled={!isModuleAvailable}>
                <Plus className="h-4 w-4 mr-2" />
