...
export default function PagosConciliacionPage() {
  ...
  const fetchData = async () => {
    setError(null);
    const [transactionsResponse, ordenesResponse] = await Promise.all([
      dataProvider.listBankTransactions(),
      dataProvider.listOrdenesCompra({ pageSize: 500 }),
    ]);
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          {loading && <p className="text-sm text-muted-foreground">Procesando CSV...</p>}
